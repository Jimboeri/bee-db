...
class ModelTests(TestCase):
    ...
    def setUpTestData(cls):
        cls.etUser = User.objects.get(
            username="roderick@west.net.nz"
        )  # defined in fixture1
    ...
    def test_Model_Colony(self):
        ...
        insp2 = models.Inspection.objects.create(
            colony=self.col1, dt=timezone.now(), notes="Latest Inspection"
        )
    ...
    def test_Model_Inspection(self):
        ...
        self.assertEqual(
            insp2.__str__(),
            f"Date: {insp2.dt}, Colony: {insp2.colony.colonyID}, health: {insp2.healthScore():.1f}",
        )
        # check valid data
        insp2.numbers = 2
        insp2.size = 3
        ...
        insp2.eggs = 2
        self.assertEqual(
            "Lots of eggs & larvae, but spotty brood", insp2.eggChoiceDisplay()
        )
        insp2.eggs = 25
