...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='inspection',
            name='numbers',
            field=models.IntegerField(choices=[(0, 'Not recorded'), (1, 'Bees on 20 or more frames'), (2, 'Bees on 10 - 20 frames'), (3, 'bees on 4 - 9 frames'), (4, 'Bees on 3 or less frames'), (5, 'Less than a frame of bees')], default=0, help_text='How many bees in the hive'),
        ),
        migrations.AlterField(
            model_name='inspection',
            name='temper',
            field=models.IntegerField(choices=[(0, 'Not recorded'), (1, 'Calm bees'), (3, 'Bees a bit defensive'), (5, 'Bees attach beekeeper')], default=0, help_text='How happyy is the hive'),
        ),
        migrations.AlterField(
            model_name='inspection',
            name='varroa',
